...
public class XMLWriteAndRead {
    public static void main(String[] args) {
        ...
        try {
            ...
            String xmlStringCars = mapper.writeValueAsString(carList);

            System.out.println(xmlStringCars);


            writer = new PrintWriter(new FileWriter("hanCarListXML.xml"));

            writer.println(xmlStringCars);
